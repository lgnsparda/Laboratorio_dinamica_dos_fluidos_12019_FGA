...
•	Todos os membros do grupo na etapa 3 foram responsáveis pela montagem e execução do procedimento.
• Todos os membros do grupo na etapa 3 foram responsáveis pela edição do no word e o integrante matheus foi responsável por passar para  github.
